...
- Upsert Document/Chunk nodes into Graphiti-backed Neo4j graph.
- Keep interface stable so later we can swap to native Graphiti abstractions.
"""
...
class GraphitiIngestionService:
    """Persist parsed chunks with metadata into Graphiti graph backend."""
...
graphiti_ingestion_service = GraphitiIngestionService()
