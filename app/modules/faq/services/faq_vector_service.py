...
_faq_vector_service_instance: Optional['FaqVectorService'] = None
...
async def get_faq_vector_service() -> FaqVectorService:
    global _faq_vector_service_instance
    if _faq_vector_service_instance is None:
        async with _faq_qdrant_lock:
            if _faq_vector_service_instance is None:
                _faq_vector_service_instance = FaqVectorService()
    return _faq_vector_service_instance
