...
class InteractionLogRepository(BeanieRepository[InteractionLogDocument]):
    """Repository-specific queries for interaction log documents."""

    document_class = InteractionLogDocument
